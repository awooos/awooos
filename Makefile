...
KERNEL_EXE_LIBRARIES += -l :bootstrap-${TARGET}.a -l :awoostr.a -l :ktest.a -l :badmalloc.a -l :hal-${TARGET}.a -l :libpanic.a -l :libpanic-${TARGET}.a -l :eventually.a -l :scheduler.a -l :libc.a
