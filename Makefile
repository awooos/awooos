...
override CFLAGS += -std=c11 -pedantic-errors -gdwarf-2 -nostdinc \
					...
					-Wall -Wextra -Wmost -Wpedantic              \
					-Wbad-function-cast -Wcomma        \
					-Wconditional-uninitialized -Wconversion     \
					-Wdeprecated -Wdivision-by-zero              \
					-Wfloat-equal -Wformat-nonliteral \
					-Wheader-hygiene   \
					-Widiomatic-parentheses \
					-Wimplicit-fallthrough \
					-Wloop-analysis -Wmissing-braces \
					-Wmissing-noreturn -Wnested-anon-types \
					-Wnewline-eof -Wpacked -Wpadded \
					-Wrange-loop-analysis -Wshadow-all \
					-Wshorten-64-to-32 -Wsign-compare -Wsign-conversion \
					-Wsometimes-uninitialized -Wstring-conversion \
					-Wswitch-enum -Wtautological-overlap-compare \
					-Wundef -Wunreachable-code-aggressive -Wunused \
