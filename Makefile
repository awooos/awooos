...
override C_INCLUDES += -I include -I src/libraries/dmm/include -I src/libraries/ali/include -I src/libraries/flail/include -I src/libraries/tinker/include -I src/libraries/hal/include -I src/libraries/greeter/include -I src/libraries/tests/include -I src/libraries/shell/include
