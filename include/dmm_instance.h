...
#define dmm_instance_malloc(instance, size) _dmm_instance_malloc(instance, size, __FUNCTION__, __FILE__, __LINE__)

void _dmm_instance_free(void *instance, void *ptr, const char function[],
        const char filename[], size_t line);
#define dmm_instance_free(instance, ptr) _dmm_instance_free(instance, ptr, __FUNCTION__, __FILE__, __LINE__)

void *_dmm_instance_realloc(void *instance, void *ptr, size_t size,
        const char function[], const char filename[], size_t line);
#define dmm_instance_realloc(instance, ptr, size) _dmm_instance_realloc(instance, ptr, size, __FUNCTION__, __FILE__, __LINE__)
